  ...
  return (
    <>
      <header id="home" className="relative">
        <div className="w-[22%] ml-[10rem] max-xl:ml-[4rem] max-xl:w-[28%] max-md:ml-6 max-md:w-[40%] max-sm:w-[55%]">
          <img src="/kartavya_logo.png" alt="Kartavya Logo" />
        </div>

        <Button
          onClick={userLoggedIn ? handleLogout : () => navigate("/login")}
          className="absolute top-[10%] right-[10%] h-16 w-44 text-[1.5rem]
        ...
        <div className="flex max-[767px]:justify-center">
          <motion.div
            ...
            viewport={{ once: true }}
            className="ml-[8%] flex flex-col text-[95px]
        ...
        <div
          className="ml-[8%] mt-[6%] flex gap-6
        ...
        >
          ...
          <Button
            variant="outline"
            className="border-[1.5px] border-black rounded-lg font-bold px-10 py-5 text-[1.1rem]
      ...
      <main>
        ...
        <section id="dash" className=" w-full bg-white  max-sm:px-8 my-8 pb-9">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center w-full px-[15vw]">
      ...
      >
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className=" text-[1.6rem] leading-relaxed font-playpen">
            ...
            S/63750/2008) run by the students and the alumni of IIT (ISM)
            Dhanbad and other associated colleges with the vision to equip the
            children of slums with education, life skills and character that
